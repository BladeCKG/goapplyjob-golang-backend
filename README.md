...
- `SMTP_PASS`
- `SMTP_FROM`
- or `BREVO_API_KEY`/`BREVO_API_KEYS` with `BREVO_FROM_EMAIL`
- or `MAILTRAP_API_TOKEN`/`MAILTRAP_API_TOKENS` with `MAILTRAP_FROM_EMAIL`
- or `CYBERPANEL_API_KEY`/`CYBERPANEL_API_KEYS` with `CYBERPANEL_FROM_EMAIL`
