...
type Querier interface {
	...
	GetCancelableCardPaymentByUser(ctx context.Context, arg GetCancelableCardPaymentByUserParams) (*GetCancelableCardPaymentByUserRow, error)
	...
	ListRecentDodoCardPayments(ctx context.Context, limit int32) ([]*ListRecentDodoCardPaymentsRow, error)
