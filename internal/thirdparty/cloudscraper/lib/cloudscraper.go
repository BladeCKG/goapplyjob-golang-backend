...
import (
	...
	"goapplyjob-golang-backend/internal/thirdparty/cloudscraper/lib/transport"
	"goapplyjob-golang-backend/internal/thirdparty/cloudscraper/lib/user_agent"
...
// GetWithContext performs a GET request bound to the provided context.
func (s *Scraper) GetWithContext(ctx context.Context, url string) (*http.Response, error) {
...
func (s *Scraper) Post(url, contentType string, body io.Reader) (*http.Response, error) {
	return s.PostWithContext(context.Background(), url, contentType, body)
}

// PostWithContext performs a POST request bound to the provided context.
func (s *Scraper) PostWithContext(ctx context.Context, url, contentType string, body io.Reader) (*http.Response, error) {
